...
<div class="card-body card-body-myform"><h5 class="card-title">New Orders</h5>

<table class=" table table-xs table-danger table-bordered">
...
$chatrequest=DB::select("select uid,total_price,created_at from orders $createria_neworder GROUP by uid order by id desc limit 5");
$i=1;
...
<td  title="Total">R <?php echo $row->total_price; ?></td>
    ...
    <!--new orders-->
        <!--Recent Orders-->
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="card-body card-body-myform"><h5 class="card-title">Requested Orders</h5>
