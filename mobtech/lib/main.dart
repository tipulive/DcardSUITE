...
import 'package:mobtech/services/ussd_service.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () async {
                if (await Permission.phone.request().isGranted) {
                  String? _res = await UssdAdvanced.sendAdvancedUssd(code:_controller.text, subscriptionId: 0);
                  print(_res.toString());
                  setState(() {
                    usdResponse=_res;
                  });
            ...
            ElevatedButton(
              onPressed: () async {
                if (await Permission.phone.request().isGranted) {
                  String? _res = await UssdAdvanced.multisessionUssd(code: _controller.text, subscriptionId: 2);
                  /*print(_res);
                  setState(() {
                    usdResponse=_res;
                  });*/
                String? _res2 = await UssdAdvanced.sendMessage('1');
                  ...
                  String? _res4 = await UssdAdvanced.sendMessage('0782389359');
                  setState(() {
                    usdResponse=_res4;
                  });
                  /*print(_res2);
              ...
              child: const Text('Real multi session\nrequest'),
            ),
            ElevatedButton(
              onPressed: () async {
                if (await Permission.phone.request().isGranted) {
