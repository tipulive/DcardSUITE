            ...
            children: [
                  ...
                  return
                    ...
                    Row(
                      ...
                      children:  [
                        ...
                        InkWell(
                            ...
                            child: Text('${(Get.put(StockQuery()).order)["resultData"][0]["name"]}', style: TextStyle(fontSize: 16.0))),
                        SizedBox(width: 8.0),
                        IconButton(
                    ...
                    Row(
                      ...
                      children:  [
                        ...
                        Text('${(Get.put(StockQuery()).order)["resultData"][0]["name"]}', style: TextStyle(fontSize: 16.0)),
              ...
              if(((Get.put(StockQuery()).order)["resultData"][0]["uid"])!="none")
                ...
                Row(
                  ...
                  children:  [
                    // Adjust the space between icon and text
                    Text("OrderId:${(Get.put(StockQuery()).order)["resultData"][0]["uid"]}", style: TextStyle(fontSize: 16.0)),
                    SizedBox(width: 8.0),
                    IconButton(
...
//Method
  ...
  performSearch(String text,String statusSearch) async{
    ...
    try {
      ...
      var resultData=(await StockQuery().product(QuickBonus(uid:text,productName:'none',status:statusSearch),Topups(optionCase:"search",startlimit:1,endlimit:10))).data;
    ...
    if((Get.put(StockQuery()).userProfile)["uid"]=="none")
    {
      Get.dialog(
        AlertDialog(
          ...
          content: Text('Please Choose Client By?'),
          actions: [
            ElevatedButton(
              style: ElevatedButton.styleFrom(
  ...
  pickDefaultUser(resetOrder) async{
                ...
                child: Center(
                  child: IconButton(
                    ...
                    onPressed: () {
                      ...
                      addcomentCheckout(chekoutResult[index]["productCode"],"${chekoutResult[index]["description"]}");
                      //open
                    },
                  ),
                ),
