...
class ViewRepayBorrowUidComp extends StatefulWidget {
  const ViewRepayBorrowUidComp({Key? key}) : super(key: key);

  @override
  State<ViewRepayBorrowUidComp> createState() => _ViewRepayBorrowUidCompState();
}

class _ViewRepayBorrowUidCompState extends State<ViewRepayBorrowUidComp> {
                      ...
                      children: [
                        Wrap(
                          ...
                          children: [
                            ...
                            Text("${(_data.isNotEmpty)?totalAmount:0}",style:GoogleFonts.pacifico(fontSize:15,color: Colors.orange,fontWeight: FontWeight.w700)),
