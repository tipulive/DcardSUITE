...
import 'package:dStock/Pages/components/adminPayments/ViewRepaySafeUidComp.dart';
...
import '../../SetPage.dart';
import 'SafeByUidComp.dart';





class SafePaymentComp extends StatefulWidget {
  const SafePaymentComp({Key? key}) : super(key: key);

  @override
  State<SafePaymentComp> createState() => _SafePaymentCompState();
}

class _SafePaymentCompState extends State<SafePaymentComp> {
                      ...
                      children: [
                        Wrap(
                          ...
                          children: [
                            ...
                            Text("${(_data.isNotEmpty)?_data[0]['safeBalance']:0}",style:GoogleFonts.pacifico(fontSize:15,color: Colors.orange,fontWeight: FontWeight.w700)),
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      ...
                                      const Icon(Icons.segment,color:Colors.orange,size:13,),
                                      Text("Unpaid:${_data[index]['amount']}"),
                            ...
                            Row(
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    Get.to(() =>SetPage(dynamicMethod: () {
                                      return const ViewRepaySafeUidComp();
                                    }),arguments:{
                                      "title":"${_data[index]['Recipient']} Received Balance",
                                      "userid":_data[index]['recipientId'],
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async{
                                    Get.to(() =>SetPage(dynamicMethod: () {
                                      return const SafeByUidComp();
                                    }),arguments:{
                                      "title":"${_data[index]['Recipient']}",
                                      "userId":_data[index]['recipientId'],
                                      "totalAmount":_data[index]['amount']
                                    });
                                  },
  ...
  viewData(nameVal,searchVal) async
  {
    ...
    var resultData=(await StockQuery().viewSafeBalance(Topups(startlimit:limit,endlimit:_page,name:nameVal,searchOption:searchVal))).data;
