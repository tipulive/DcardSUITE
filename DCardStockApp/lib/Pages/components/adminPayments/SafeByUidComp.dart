...
class SafeByUidComp extends StatefulWidget {
  const SafeByUidComp({Key? key}) : super(key: key);

  @override
  State<SafeByUidComp> createState() => _SafeByUidCompState();
}

class _SafeByUidCompState extends State<SafeByUidComp> {
