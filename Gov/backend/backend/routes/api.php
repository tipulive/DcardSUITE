...
/*driving app*/
Route::match(['get', 'post','put'], '/pricing', 'CompanyController@pricing')->name('pricing');
Route::match(['get', 'post','put'], '/driving', 'CompanyController@driving')->name('driving');
Route::match(['get', 'post','put'], '/cartejaune', 'CompanyController@cartejaune')->name('cartejaune');
Route::match(['get', 'post','put'], '/plaque', 'CompanyController@plaque')->name('plaque');
Route::match(['get', 'post','put'], '/ticketpricing', 'CompanyController@ticketpricing')->name('ticketpricing');
Route::match(['get', 'post','put'], '/ticketwriting', 'CompanyController@ticketwriting')->name('ticketwriting');
/*driving app*/
/*Taxation */
...
Route::post('/TaxplaceDeclareOrder','CompanyController@TaxplaceDeclareOrder')->name('TaxplaceDeclareOrder');
Route::post('/TaxSubmitDeclareOrder','CompanyController@TaxSubmitDeclareOrder')->name('TaxSubmitDeclareOrder');
/*Taxation */
/*Company*/
