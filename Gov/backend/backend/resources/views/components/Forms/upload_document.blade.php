    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="card-title">
                <h3 class="text-center title-2">Upload Documents</h3>
            </div>
            <hr>
            <form action="" method="post" novalidate="novalidate">
                <div class="form-group">
                    <label for="cc-payment" class="control-label mb-1">Document Name</label> 
                    <input id="doc_name" name="doc_name" type="text" class="form-control"  required>
                </div>
