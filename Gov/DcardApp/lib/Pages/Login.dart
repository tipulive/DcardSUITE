...
// timeout only works on Android, while the latter two messages are only for iOS
    ...
    setState(() {
      _result=jsonEncode(tag);
    });
    if (tag.type == NFCTagType.iso7816) {
      var result = await FlutterNfcKit.transceive("00B0950000"); // timeout is still Android-only, persist until next change
      print(result);
