...
<div class="app-sidebar__inner">
              ...
              <!--Transport  Code-->
                 <li class="app-sidebar__heading">Transport</li>
                        <li class="mm-active">
                                <a href="#" aria-expanded="true">
                                    <i class="metismenu-icon pe-7s-rocket"></i>Transport
                            ...
                            <ul class="mm-collapse mm-show" style="">
                                   <li>
                                    ...
                                    <li>
                                        <a href="#View Shipping" onclick="return loadTrip('LoadLocations','uidNone','true')" aria-expanded="false">
                                            <i class="metismenu-icon"></i>Locations
                                        </a>
                                    </li>

                                    <li>
                                        <a href="#View Shipping" onclick="return viewAllDashTrip()" aria-expanded="false">
                                            <i class="metismenu-icon"></i>Add Trip
                                        </a>
                                    </li>
...
`;
var modalTable=`<div  class="modal fade bd-example-modal-lg myModal2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="modalMainFormTable"></div>
      </div>
...
<form class="formCreateLocation" onsubmit="return createLocation()">
<div class="p-2">
...
<input type="text" class="form-control driverTelClass" name="tag"  autocomplete="off" onkeyup="autoCompleteShipUser(this,'driverTel','Tags')" required/>
<span class="autocompleteIcon driverTel_icon" onclick="hidePopupShip('driverTel')"><i class="fas fa-exclamation-triangle text-danger" ></i></span>
</div>
<ul class="list-group  autoCompleteTopItem driverTel disNone">
...
<input type="text" class="form-control priceClass" name="price"  autocomplete="off" onkeyup="autoCompleteShipUser(this,'price','Price')" required/>
<span class="autocompleteIcon price_icon" onclick="hidePopupShip('price')"><i class="fas fa-exclamation-triangle text-danger" ></i></span>
</div>
<ul class="list-group  autoCompleteTopItem price disNone">
...
if(data.status){//return data as true
   ...
   // console.log(`done $${CalculateDeclClass}`);
    ...
    $('.formCreateLocation .form-control').val("");
    page=0;
    countNum=0;
...
function LoadAllDashTripTemplate(data){
    //
//console.log(data.permission.shippingEditStatus);
 var permission=JSON.parse(data.permission);
 var todaysDate=data.todaysDate;
...
var resultObject=resultData[i];
 ...
 <tr>
  ...
  <td data-label="date ON"><p>${resultData[i].dateOn}<p>
   </td>

   <td data-label="From->To"><p>${resultData[i].origin}->${resultData[i].destination}<p>
   </td>
   <td data-label="From->To"><p>${resultData[i].tag}<p>
   </td>
   <td data-label="Price"><p>${resultData[i].price}<p>
   </td>
   <td data-label="PlaQue"><p>${resultData[i].numberPlate}<p>
   </td>
   <td data-label="Car Seat"><p>${resultData[i].seatAv}<p>
   </td>
...
function loadCars(searchOption,uidThis,loadSearch){

(searchOption=='LoadCars')?$('.myModal2').modal("show"):"";
...
getData="";
if(searchOption=='LoadCars')
{
    $(`.${loadSearch=='true'?"MainForm":"t"}`).html(`<div class="MainFormTable"></div>`);
...
<th scope="col" class="${loadSearch==='false'?"":"d-none"}">Action</th>
...
var resultObject=resultData[i];
getData+=`
<div class="pb-2 ${loadSearch==='true'?"":"d-none"}">


<button type="button" class="btn btn-dark btnCreateHide" onclick="return FormRegisterVehicle()">Create</button>


</div>
<tr>
<td data-label="#"><i class="fas fa-edit text-danger mylogout ${data.permission.editOrderAction?'':'d-none'}" title="Edit This " onclick="return editMyShipping('${btoa(JSON.stringify(resultData[i]))}')"></i> |<i class="fas fa-trash text-danger mylogout ${data.permission.deleteShipping?'':'d-none'}" title="Delete This " onclick="return deleteShipping('${btoa(JSON.stringify(resultData[i]))}')"></i>  ${countNum}</td>


<td data-label="tag"><p>${resultData[i].carsName}<p>
</td>
<td data-label="tag"><p>${resultData[i].numberPlate}<p>
</td>
<td data-label="tag"><p>${resultData[i].numberSeat}<p>
</td>
<td data-label="Action" class="${loadSearch==='false'?"":"d-none"}"><button type="button" class="btn btn-dark " onclick="return loadCars('${'LoadThisCar'}','${resultData[i].uid}')">Load This</button>
</td>
...
$(`.${loadSearch=='true'?"MainFormTable":"modalMainFormTable"}`).html(getData);
}
else{
    $('.myModal2').modal("hide");
getData+=`<div class="form-group right-inner-addon">
<label>Cars Name <span class="text-danger">*</span></label>
<input type="text" class="form-control " name="carsName"  value="${data.result[0].carsName}" required/>

</div>
<div class="form-group right-inner-addon">
<label>Plaque <span class="text-danger">*</span></label>
<input type="text" class="form-control " name="numberPlate" value="${data.result[0].numberPlate}"  required/>
</div>
<div class="form-group right-inner-addon">
<label>Seat <span class="text-danger">*</span></label>
<input type="text" class="form-control " name="seatAv" value="${data.result[0].numberSeat}" required/>
</div>


`

$('.loadSeat').html(getData);
...
function loadTrip(searchOption,uidThis,loadSearch){

    (searchOption=='LoadLocations')?$('.myModal2').modal("show"):"";
...
<button type="button" class="btn btn-dark btnCreateHide" onclick="return FormCreateLocation()">Create</button>
...
var resultObject=resultData[i];
 ...
 <tr>
  <td data-label="#"><i class="fas fa-edit text-danger mylogout ${data.permission.editOrderAction?'':'d-none'}" title="Edit This " onclick="return editMyShipping('${btoa(JSON.stringify(resultData[i]))}')"></i> |<i class="fas fa-trash text-danger mylogout ${data.permission.deleteShipping?'':'d-none'}" title="Delete This " onclick="return deleteShipping('${btoa(JSON.stringify(resultData[i]))}')"></i>  ${countNum}</td>
   ...
   <td data-label="tag"><p>${resultData[i].tag}<p>
   </td>
   <td data-label="action" class="${loadSearch==='false'?"":"d-none"}"><button type="button" class="btn btn-dark " onclick="return loadTrip('${'LoadThisLocation'}','${resultData[i].uid}')">Load This</button>
   </td>
...
getData+=`<div class="form-group right-inner-addon">
<label>Origin <span class="text-danger">*</span></label>
<input type="text" class="form-control " name="origin"  value="${data.result[0].origin}" required/>
<input type="hidden" class="form-control locationId" name="location" value="${data.result[0].uid}"  required/>
</div>
<div class="form-group right-inner-addon">
<label>Destination <span class="text-danger">*</span></label>
<input type="text" class="form-control " name="destination" value="${data.result[0].destination}"  required/>
</div>
<div class="form-group right-inner-addon">
<label>Tag <span class="text-danger">*</span></label>
<input type="text" class="form-control " name="tag" value="${data.result[0].tag}" required/>
</div>
<div class="form-group right-inner-addon">
<label>Price <span class="text-danger">*</span></label>
<input type="text" class="form-control " name="price" value="${data.result[0].price}" required/>
</div>

`

$('.loadLocation').html(getData);
...
<button type="button" class="btn btn-dark btnCreateHide" onclick="return FormAddDashboardTrip()">Create</button>
...
${modalTable}
<input type="hidden" class="form-control locationId" name="location"  required/>
<form class="formAddDashboardTrip" onsubmit="return AddDashboardTrip()">
<div class="p-2">
<span class="autocompleteIcon " onclick="loadTrip('${'LoadLocations'}','${'uidNone'}','${'false'}')"><i class="fas fa-exclamation-triangle text-danger" ></i>Load Location</span>
<div class="loadLocation">
</div>
<span class="autocompleteIcon " onclick="loadCars('${'LoadCars'}','${'uidNone'}','${'false'}')"><i class="fas fa-exclamation-triangle text-danger" ></i>Load Seat</span>
<div class="loadSeat">
</div>

<div class="d">
        <label>Date On</label>
<input type="text" class="form-control eta" id="datetime-picker" name="dateOn" placeholder="choose Date"/>
        </div>
...
function AddDashboardTrip(){
    //$('.cover-spin').show();
    var Usertoken=localStorage.getItem("Usertoken");
$.ajax({

url:`./api/addDashboardTrip`,
type:'post',
beforeSend: function (xhr) {
xhr.setRequestHeader('Authorization', `Bearer ${Usertoken}`);
},
dataType: "json",
data:$('.formAddDashboardTrip').serialize(),
success:function(data){
if(data.status){//return data as true
    console.log(data);
    $('.cover-spin').hide();
   ...
   // console.log(`done $${CalculateDeclClass}`);
    ...
    $('.formAddDashboardTrip .form-control').val("");
    page=0;
    countNum=0;

    viewAddDashboardTrip();
...
if(data.status){//return data as true
   ...
   // console.log(`done $${CalculateDeclClass}`);
    ...
    loadTrip('LoadLocations','uidNone','true');
...
<form class="formRegisterVehicle" onsubmit="return registerVehicle()">
<div class="p-2">
...
<div class="form-group right-inner-addon">
<label>Cars Name <span class="text-danger">*</span></label>
<input type="text" class="form-control clientTelClass" name="carsName" autocomplete="off" onkeyup="autoCompleteShipUser(this,'clientTel','Users')"/>
<span class="autocompleteIcon clientTel_icon" onclick="hidePopupShip('clientTel')"><i class="fas fa-exclamation-triangle text-danger" ></i></span>
</div>
<ul class="list-group  autoCompleteTopItem clientTel disNone">
...
<input type="text" class="form-control clientMarkClass" name="numberSeat" autocomplete="off" onkeyup="autoCompleteShipUser(this,'clientMark','NumberSeat')"/>
<span class="autocompleteIcon clientMark_icon" onclick="hidePopupShip('clientMark')"><i class="fas fa-exclamation-triangle text-danger" ></i></span>
</div>
<ul class="list-group  autoCompleteTopItem clientMark disNone">
...
url:`./api/registerVehicle`,
type:'post',
beforeSend: function (xhr) {
xhr.setRequestHeader('Authorization', `Bearer ${Usertoken}`);
},
dataType: "json",
data:$('.formRegisterVehicle').serialize(),
success:function(data){
if(data.status){//return data as true
    console.log(data);
    $('.cover-spin').hide();
   ...
   // console.log(`done $${CalculateDeclClass}`);
    ...
    $('.formRegisterVehicle .form-control').val("");
    page=0;
    countNum=0;

    loadCars('LoadCars','uidNone','true');
