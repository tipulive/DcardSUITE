...
class CompanyController extends Controller
{
    ...
    /*Appointment Company */
    public function ussdViewCreate(Request $request){
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new appointmentController)->ussdViewCreate($input);
            }
            else{
                return response([
                    "status"=>false,
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new appointmentController)->getCode($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function applicationAppointment(Request $request){
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new appointmentController)->applicationAppointment($input);
            }
            else{
                return response([
                    "status"=>false,
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new appointmentController)->code($input);
            }
            else{
                return response([
                    "status"=>false,
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new appointmentController)->appointment($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    /*Appointment Company */
    /*travel Company*/
    public function viewAllDashTrip(Request $request){
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TransportController)->viewAllDashTrip($input);
            }
            else{
                return response([
                    "status"=>false,
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TransportController)->viewAllLocations($input);
            }
            else{
                return response([
                    "status"=>false,
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TransportController)->viewAllCars($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function LocationTrip(Request $request){
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TransportController)->LocationTrip($input);
            }
            else{
                return response([
                    "status"=>false,
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TransportController)->Cars($input);
            }
            else{
                return response([
                    "status"=>false,
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new shippingController)->searchShipUser($input);
            }
            else{
                return response([
                    "status"=>false,
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new shippingController)->deleteShipping($input);
            }
            else{
                return response([
                    "status"=>false,
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new shippingController)->editShipping($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function shipSearch(Request $request) {
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new shippingController)->shipSearch($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function viewAllShipping(Request $request) {
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new shippingController)->viewAllShipping($input);
            }
            else{
                return response([
                    "status"=>false,
        ...
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new shippingController)->ShippingCreate($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function editStatShip(Request $request) {
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new shippingController)->editStatShip($input);
            }
            else{
                return response([
                    "status"=>false,
