...
class StockQuery extends GetxController{
  ...
  //Appointment//
  getCode() async{//get Code to display when loggin
    try {
      ...
      var url="${ConstantClassUtil.urlLink}/getCode";
  ...
  createCode(Appointment appointmentData) async{

    try {

      var params =  {

        "code":appointmentData.codeb,
        "code_name":appointmentData.codeName,
        "code_status":appointmentData.codeStatus,
        "status":appointmentData.status,
        "commentData":appointmentData.commentData

        //"options": [1,2,3],
      };
      String authToken =(Get.put(AdminQuery()).obj)["result"][0]["AuthToken"];
      var url="${ConstantClassUtil.urlLink}/code";
  ...
  createAppointment(Appointment appointmentData) async{

    try {

      var params =  {

        "actionStatus":appointmentData.actionStatus,
        "uid":appointmentData.uid,
        "codeb":appointmentData.codeb,
        "name":appointmentData.codeName,
        "limitb":appointmentData.limitb,
      ...
      String authToken =(Get.put(AdminQuery()).obj)["result"][0]["AuthToken"];
      var url="${ConstantClassUtil.urlLink}/appointment";
      var response = await Dio().post(url,
        options: Options(headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:"Bearer $authToken"
  ...
  displayAppointment() async{//this is to Load all Appointment
    try {
      ...
      String authToken =(Get.put(AdminQuery()).obj)["result"][0]["AuthToken"];
      var url="${ConstantClassUtil.urlLink}/displayAppointment";
      var response = await Dio().get(url,
        options: Options(headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:"Bearer $authToken"
  ...
  viewThisAppointmentApplication(Appointment appointmentData) async{//view This Appointment Application
    try {
      ...
      String authToken =(Get.put(AdminQuery()).obj)["result"][0]["AuthToken"];
      var url="${ConstantClassUtil.urlLink}/applicationAppointment";
      var response = await Dio().get(url,
        options: Options(headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:"Bearer $authToken"
  ...
  //Appointment//
//Mdrivers//
  viewSearchLocation(Transport transpData) async{
    try {

      var params =  {

        "searchItem":transpData.searchItem,
        "searchOption":transpData.searchOption


      };
      String authToken =(Get.put(AdminQuery()).obj)["result"][0]["AuthToken"];
      var url="${ConstantClassUtil.urlLink}/viewSearchLocation";
      var response = await Dio().get(url,
        options: Options(headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:"Bearer $authToken"
  ...
  searchTransport(Transport transpData) async{
    try {

      var params =  {

        "origin":transpData.origin,
        "destination":transpData.destination,
        "dateOn":transpData.dateOn,
        "searchOption":transpData.searchOption,
      ...
      String authToken =(Get.put(AdminQuery()).obj)["result"][0]["AuthToken"];
      var url="${ConstantClassUtil.urlLink}/SearchTransport";
      var response = await Dio().get(url,
        options: Options(headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:"Bearer $authToken"
  ...
  viewSeat(Transport transpData) async{
    try {

      var params =  {

        "uid":transpData.uidTransport,
        "seatAv":transpData.seat


      };
      String authToken =(Get.put(AdminQuery()).obj)["result"][0]["AuthToken"];
      var url="${ConstantClassUtil.urlLink}/viewSeat";
      var response = await Dio().get(url,
        options: Options(headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:"Bearer $authToken"
  ...
  bookTicket(Transport transpData) async{
    ...
    try {
      ...
      var params =  {
        ...
        "uid":transpData.uidTransport,
        "seat":transpData.seat,
        "name":transpData.name,
        "phone":transpData.phone,
        "commentData":transpData.commentData

        //"options": [1,2,3],
      };
      String authToken =(Get.put(AdminQuery()).obj)["result"][0]["AuthToken"];
      var url="${ConstantClassUtil.urlLink}/BookTicket";
      var response = await Dio().post(url,
        options: Options(headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:"Bearer $authToken"
  ...
  stockCount(Topups topupData,QuickBonus product,User user) async{
    ...
    try {
      ...
      var params =  {
        ...
        "uid":topupData.uid,
        "productCode":product.uid,
        //"qty_Transport":int.tryParse("${product.qty}"),
        "qty_Transport":int.parse("${product.qty}"),
