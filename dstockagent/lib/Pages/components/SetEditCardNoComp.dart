...
class SetEditCardNoComp extends StatefulWidget {
  const SetEditCardNoComp({super.key});
                  ...
                  child: ElevatedButton(
                    ...
                    //print(resultData);
                      ...
                      if(resultData["status"])
                      {
                        ...
                        Get.snackbar("Success", "Profile Edited Successfuly",backgroundColor: const Color(0xff9a1c55),
                        ...
                        Get.snackbar("Error", "${resultData["message"]??"System Error use another Card"} ,Or Please Contact System Admin",backgroundColor: const Color(
                            0xffdc2323),
                            colorText: const Color(0xffffffff),
                            titleText: const Text("Card User",style:TextStyle(color:Color(
                                0xffffffff),fontSize:18,fontWeight:FontWeight.w500,fontStyle: FontStyle.normal),),
