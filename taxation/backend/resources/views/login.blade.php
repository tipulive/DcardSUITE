    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-6">
            ...
            <div class="success-data" v-else>
                    <div class="text-center d-flex flex-column"> <i class='bx bxs-badge-check'></i> <span class="text-center fs-1">User Login</span> </div>
                </div>
                <div class="form-data" >
                    ...
                    <div class="mb-3"> <input type="submit" class="btn btn-dark w-100" value="Login" onclick="return Form_UserLogin()"> </div>
                </div>
