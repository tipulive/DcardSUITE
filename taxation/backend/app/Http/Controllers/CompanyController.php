...
class CompanyController extends Controller
{
    ...
    public function SumReportTotal(Request $request) {
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TaxationController)->SumReportTotal($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function TaxCategory(Request $request) {
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TaxationController)->Category($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function TaxMeasurement(Request $request) {
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TaxationController)->Measurement($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function Taxproduct(Request $request) {
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TaxationController)->Taxproduct($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function TaxplaceDeclareOrder(Request $request) {
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TaxationController)->placeDeclareOrder($input);
            }
            else{
                return response([
                    "status"=>false,
    ...
    public function TaxSubmitDeclareOrder(Request $request) {
        if(Auth::check())
        {
        if(Auth::user()->platform==$this->platform1)
            {
                ...
                return (new TaxationController)->SubmitDeclareOrder($input);
            }
            else{
                return response([
                    "status"=>false,
