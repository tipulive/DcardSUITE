...
import 'package:dStock/Pages/components/adminPayments/BorrowByUidComp.dart';
import 'package:dStock/Pages/components/adminPayments/ViewRepayBorrowUidComp.dart';
...
class BorrowPaymentComp extends StatefulWidget {
  const BorrowPaymentComp({Key? key}) : super(key: key);

  @override
  State<BorrowPaymentComp> createState() => _BorrowPaymentCompState();
}

class _BorrowPaymentCompState extends State<BorrowPaymentComp> {
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: RichText(
                                          text: TextSpan(
                                            text: "Balance:${_data[index]['amount']}",
                                            style: DefaultTextStyle.of(context).style,
                                            children: const <TextSpan>[
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      ...
                                      const Icon(Icons.segment,color:Colors.orange,size:13,),
                                      Text("By:${_data[index]['AmountOwner']}"),
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    Get.to(() =>SetPage(dynamicMethod: () {
                                      return const ViewRepayBorrowUidComp();
                                    }),arguments:{
                                      "title":"${_data[index]['AmountOwner']} Received Balance",
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async{
                                    ...
                                    uidReceiver=_data[index]['OwnerDept'];

                                    adminPaidBack(_data[index]['AmountOwner'],_data[index]['amount']);
  ...
  viewData(nameVal,searchVal) async
  {
    ...
    var resultData=(await StockQuery().viewBorrowBalance(Topups(startlimit:limit,endlimit:_page,name:nameVal,searchOption:searchVal))).data;
  ...
  adminPaidBackMethod() async{

    try {
      (Get.put(StockQuery()).updateHideLoader(false));
      var resultData=(await StockQuery().repaidBack(Topups(uid:uidReceiver,amountBalance:inputData,desc:commentData.text))).data;
      if(resultData["status"])
      {
        viewData('test',false);
  ...
  void adminPaidBack(amountOwner,dept) async{
                                              ...
                                              children: [
                                                Wrap(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(amountOwner,style:GoogleFonts.odorMeanChey(fontSize:16,color: Colors.green,fontWeight: FontWeight.w700)),
                                                ...
                                                Wrap(
                                                  ...
                                                  children: [
                                                    ...
                                                    const Icon(Icons.segment,color:Colors.orange,size:13,),
                                                    Text("${dept}",style:GoogleFonts.pacifico(fontSize:15,color: Colors.orange,fontWeight: FontWeight.w700)),
