...
import '../../SetPage.dart';
import 'StockSpendingComp.dart';





class SafariComp extends StatefulWidget {
  const SafariComp({Key? key}) : super(key: key);

  @override
  State<SafariComp> createState() => _SafariCompState();
}

class _SafariCompState extends State<SafariComp> {
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async{
                                    ...
                                    Get.to(() =>SetPage(dynamicMethod: () {
                                      return const StockSpendingComp();
                                    }),arguments:{
                                      "title":"Stock ${_data[index]['name']}",
                                      "safariId":_data[index]['uid'],
                                      "safariName":_data[index]['name']
                                    });
  ...
  viewData(nameVal,searchVal) async
  {
    ...
    var resultData=(await StockQuery().getSafaris(Topups(startlimit:limit,endlimit:_page,name:nameVal,searchOption:searchVal))).data;
